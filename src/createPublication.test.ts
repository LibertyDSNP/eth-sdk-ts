  ...
  const messages = [
    {
      ...
      createdAt: 1627324121352, // Fix createdAt so snapshot doesn't change
    },
  ];
  ...
  const messages = [
    ...
    },
    {
      ...createReaction(
        "dsnp://0x0123456789ABCDEF",
        "🏳️‍🌈",
        "dsnp://0x0123456789ABCDE0/0x0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF"
      ),
      createdAt: 1627324121352, // Fix createdAt so snapshot doesn't change
    },
  ];
