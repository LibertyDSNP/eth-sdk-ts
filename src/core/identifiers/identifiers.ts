...
import { HexSerializable, serializeToHex } from "../announcements";
 ...
 */
export const convertToDSNPUserURI = (value: HexSerializable): DSNPUserURI => {
  return `dsnp://${serializeToHex(value)}`;
};
