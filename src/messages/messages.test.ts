...
describe("messages", () => {
  ...
  describe("#verify", () => {
    it("returns a true for a valid signature", () => {
      const message = createBroadcastMessage("1", "https://dsnp.org", "0x12345");
      ...
      expect(verify(publicKey, message, signature)).toBeTruthy();
    });

    it("returns a false for an invalid signature", () => {
      const message = createBroadcastMessage("1", "https://dsnp.org", "0x12345");
      const publicKey = new Uint8Array([
        2,
        233,
      ...
      expect(verify(publicKey, message, signature)).toBeFalsy();
    });
  });
});
